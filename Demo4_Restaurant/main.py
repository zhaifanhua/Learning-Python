...
# 读取数据源或数据源地址
file_users = r'D:\Repository\Learning-Python\Demo4_Restaurant\DataSet\users.xlsx'
file_meal_order_info = r'D:\Repository\Learning-Python\Demo4_Restaurant\DataSet\meal_order_info.csv'
file_meal_order_detail = r'D:\Repository\Learning-Python\Demo4_Restaurant\DataSet\meal_order_detail.xlsx'
file_state = r'D:\Repository\Learning-Python\Demo4_Restaurant\DataSet\数据特征说明.xlsx'
...
# 打印
file_data_all = r'D:\Repository\Learning-Python\Demo4_Restaurant\DataSet/data_all.csv'
...
labels = ['100元以下', '100-200元', '200-300元', '300-400元', '400-500元', '500-600元', '600-700元', '700-800元', '800-900元',
          '900-1000元', '1000元以上']
...
for i in data_all['名字'].tolist():
    textname += i + " "
textname
wordcloud = WordCloud(font_path=r'D:\Repository\Learning-Python\Demo4_Restaurant\DataSet/font.ttf',
                      background_color='white').generate("".join(textname))
